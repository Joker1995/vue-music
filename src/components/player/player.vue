<template>
    <div class="player" v-show="playlist.length>0">
        ...
        <div class="normal-player" v-show="fullScreen">
          ...
          <div class="bottom">
            <div class="dot-wrapper">
              <span class="dot" :class="{'active':currentIndex==='cd'}"></span>
              <span class="dot" :class="{'active':currentIndex===='lyric'}"></span>
            </div>
      ...
      <audio ref="audio" :scr="currentSong.url" @play="ready" @error="error"
  ...
  export default{
    ...
    methods:{
      ...
      middleTouchEnd(e){
        ...
        const time=300
        this.$refs.lyricList.$el.style[transform]=`translate3d(${offfsetWidth}px,0,0)`
      ...
      _getPosAndScale(){
        ...
        const x=-(window.innerWidth/paddingLeft)
