<template>
    <scroll @scroll="scroll" :listen-scroll="listenScroll"
          :prode-type="prodeType" :data="data" class="listview" ref="listview">
      <ul>
    ...
    export default{
      ...
      methods:{
        ...
        onShortcutTouchMove(e){
          ...
          let anchorIndex=parseInt(this.touch.archorIndex)+delta
      ...
      watch:{
        ...
        diff(newVal){
          let fixedGroup=(newVal>0 && newVal<TITLE_HIGHT)?newVal-TITLE_HIGHT:0
